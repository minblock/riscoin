...
pkgdatadir = $(datadir)/riscoin
pkgincludedir = $(includedir)/riscoin
pkglibdir = $(libdir)/riscoin
pkglibexecdir = $(libexecdir)/riscoin
...
ACLOCAL = ${SHELL} /riscoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /riscoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /riscoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /riscoin/build-aux/missing automake-1.15
AVX2_CXXFLAGS = -mavx -mavx2
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = riscoin-cli
BITCOIN_DAEMON_NAME = riscoind
BITCOIN_GUI_NAME = riscoin-qt
BITCOIN_TX_NAME = riscoin-tx
BITCOIN_WALLET_TOOL_NAME = riscoin-wallet
...
COPYRIGHT_HOLDERS_FINAL = The Riscoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Riscoin Core
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /riscoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = riscoin
PACKAGE_BUGREPORT = https://github.com/riscoin-project/riscoin/issues
PACKAGE_NAME = Riscoin Core
PACKAGE_STRING = Riscoin Core 0.18.1
PACKAGE_TARNAME = riscoin
PACKAGE_URL = https://riscoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /riscoin
abs_srcdir = /riscoin
abs_top_builddir = /riscoin
abs_top_srcdir = /riscoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /riscoin/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/Riscoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/Riscoin-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Riscoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Riscoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
