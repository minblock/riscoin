# Support for Output Descriptors in Riscoin Core

Since Riscoin Core v0.17, there is support for Output Descriptors. This is a
...
on Riscoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Riscoin Core wallets, a convenience function `combo` is
