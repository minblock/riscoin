...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1586333509, 343733, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc02b3cc6650df9caf2c8ddd392aed50dea9d172b4c97fb2c767f8626d1d6fc8b"));
        ...
        vSeeds.emplace_back("seed-a.riscoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.riscointools.com");
        vSeeds.emplace_back("dnsseed.riscoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.riscointools.com");
        vSeeds.emplace_back("seed-b.riscoin.loshan.co.uk");
