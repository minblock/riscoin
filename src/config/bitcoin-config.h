...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Riscoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Riscoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/riscoin-project/riscoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Riscoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Riscoin Core 0.18.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "riscoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://riscoin.org/"
