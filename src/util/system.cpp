...
const char * const BITCOIN_CONF_FILENAME = "riscoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Riscoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Riscoin";
#else
    // Unix
    return pathRet / ".riscoin";
#endif
#endif
}
