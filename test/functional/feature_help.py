...
"""Verify that starting riscoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start riscoin with -h for help text")
        ...
        self.log.info("Start riscoin with -version for version information")
        ...
        self.log.info("Start riscoind with -fakearg to make sure it does not start")
